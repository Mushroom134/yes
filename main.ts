...
sprites.onOverlap(SpriteKind.Player, SpriteKind.Door, function (sprite, otherSprite) {
    if (mp.getPlayerSprite(mp.playerSelector(mp.PlayerNumber.One)).overlapsWith(portal)) {
        randommaze()
        tiles.placeOnTile(mp.getPlayerSprite(mp.playerSelector(mp.PlayerNumber.One)), tiles.getTileLocation(0, 0))
    }
    if (mp.getPlayerSprite(mp.playerSelector(mp.PlayerNumber.Two)).overlapsWith(portal)) {
        randommaze()
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.Door2, function (sprite, otherSprite) {
    if (mp.getPlayerSprite(mp.playerSelector(mp.PlayerNumber.One)).overlapsWith(Portal2)) {
        randommaze()
        tiles.placeOnTile(mp.getPlayerSprite(mp.playerSelector(mp.PlayerNumber.One)), tiles.getTileLocation(0, 0))
    }
    if (mp.getPlayerSprite(mp.playerSelector(mp.PlayerNumber.Two)).overlapsWith(Portal2)) {
        randommaze()
        tiles.placeOnTile(mp.getPlayerSprite(mp.playerSelector(mp.PlayerNumber.Two)), tiles.getTileLocation(0, 0))
    }
})
